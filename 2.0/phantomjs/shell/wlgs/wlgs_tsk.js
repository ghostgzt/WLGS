...
try{
	CrossScript('http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/lib/ajax.php', 'http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/lib/index.php?key='+key, '', 'ajax_get_data', "var results=ajax_get_data;ssend(results);");
}catch(e){alert(e);}
