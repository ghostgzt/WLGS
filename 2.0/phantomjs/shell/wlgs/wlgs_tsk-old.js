...
var ids=Array("4331","4683","20372","48716","52349","60715","97642","97643","97688","97690","97704","97705","97717","97718");
var key=getkey(data);
var runnow=0;
function runxs() {

try{
	CrossScript('http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/lib/ajax.php', 'http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/lib/index.php?key='+key+'&id=' + ids[runnow], '', 'ajax_get_data_'+runnow, "if(ajax_get_data_"+runnow+"){var results=ajax_get_data_"+runnow+";ssend(results);if((runnow+1)<ids.length){runnow=runnow+1;runxs();}else{runnow=0;}}");
}catch(e){alert(e);}
