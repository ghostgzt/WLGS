...
console.log(vsa);
var xsa=(new Date).getTime();
console.log(xsa);
if(!vsa){
fs.write('chs.ini',xsa , 'w');
}
if(parseInt(xsa)<(parseInt(vsa)+60000)){
console.log("End");
phantom.exit();
}
var xsa=(new Date).getTime();
...
function runcode() {
	page.includeJs('http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/gentle_libs.js',
	function() {
		console.log('Gentle_Libs Loaded!');
		fs.write('wlgs_logs.log', getnow() + ' Gentle_Libs Loaded!\n', 'a');
		page.includeJs('http://xkz.sturgeon.mopaas.com/phantomjs/shell/wlgs/wlgs_tsk.js',
		function() {
